(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("@binpar/jest-gql", [], factory);
	else if(typeof exports === 'object')
		exports["@binpar/jest-gql"] = factory();
	else
		root["@binpar/jest-gql"] = factory();
...
function create(data) {
  ...
  const severNetworkInterface = (0, _reactApollo.createNetworkInterface)({ uri: process.env.GQL_API_URL });
