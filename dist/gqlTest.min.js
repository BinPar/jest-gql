(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["gqlTest"] = factory();
	else
		root["gqlTest"] = factory();
...
var _storeUtils = __webpack_require__(2);
...
function isIdValue(idObject) {
    return idObject != null && typeof idObject === 'object' && idObject.type === 'id';
}
...
var _getFromAST = __webpack_require__(1);

var _cloneDeep = __webpack_require__(76);
...
var _directives = __webpack_require__(79);
...
var _graphqlAnywhere = __webpack_require__(80);
...
var _visitor = __webpack_require__(75);
...
var _queryTransform = __webpack_require__(8);
...
var _store2 = __webpack_require__(39);
...
var _Observable = __webpack_require__(43);

var _ApolloError = __webpack_require__(23);

var _types = __webpack_require__(24);

var _errorHandling = __webpack_require__(42);

var _isEqual = __webpack_require__(14);

var _maybeDeepFreeze = __webpack_require__(44);

var _maybeDeepFreeze2 = _interopRequireDefault(_maybeDeepFreeze);

var _networkStatus = __webpack_require__(11);
...
var _location = __webpack_require__(50);
...
var _warnOnce = __webpack_require__(94);
...
var _bindActionCreators = __webpack_require__(72);
...
var _baseGetTag = __webpack_require__(61);

var _baseGetTag2 = _interopRequireDefault(_baseGetTag);

var _getPrototype = __webpack_require__(66);

var _getPrototype2 = _interopRequireDefault(_getPrototype);

var _isObjectLike = __webpack_require__(68);
...
var _root = __webpack_require__(62);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(5), __webpack_require__(69)(module)))
...
var _writeToStore = __webpack_require__(9);
...
var _replaceQueryResults = __webpack_require__(84);

var _readFromStore = __webpack_require__(10);
...
var getFromAST_1 = __webpack_require__(82);
var directives_1 = __webpack_require__(83);
var storeUtils_1 = __webpack_require__(41);
...
Object.defineProperty(exports, "__esModule", { value: true });
var linkUtils_1 = __webpack_require__(46);
var graphql_tag_1 = __webpack_require__(47);
var zen_observable_ts_1 = __webpack_require__(26);
...
Object.defineProperty(exports, "__esModule", { value: true });
var link_1 = __webpack_require__(45);
...
var _syntaxError = __webpack_require__(89);
...
var _locatedError = __webpack_require__(90);
...
var _formatError = __webpack_require__(91);
...
var _createApolloClient = __webpack_require__(53);
...
const apolloClient = (0, _createApolloClient2.default)();
...
const runGQLTest = (() => {
  var _ref = _asyncToGenerator(function* (testToRun) {
    describe('GraphQL Tests', _asyncToGenerator(function* () {
      let data = {};
      const executeTest = (() => {
        var _ref3 = _asyncToGenerator(function* (testInfo, num) {
          if (testInfo.previous) {
            const results = yield Promise.all(testInfo.previous);
            results.forEach(function (testData) {
              data = Object.assign({}, data, testData);
            });
          }
        ...
        return function executeTest(_x2, _x3) {
...
var _reactApollo = __webpack_require__(54);

var _isomorphicFetch = __webpack_require__(103);

var _isomorphicFetch2 = _interopRequireDefault(_isomorphicFetch);

var _tokenInfo = __webpack_require__(104);
...
const middleWares = [{
  applyMiddleware(req, next) {
    const token = _tokenInfo2.default.token;
    if (token) {
...
function create(initialState, data) {
  const severNetworkInterface = (0, _reactApollo.createNetworkInterface)({ uri: _config2.default.endPoint, opts: data });
...
(function (global, factory) {
     true ? factory(exports, __webpack_require__(55), __webpack_require__(58), __webpack_require__(30), __webpack_require__(74), __webpack_require__(47)) : typeof define === 'function' && define.amd ? define(['exports', 'react', 'prop-types', 'redux', 'apollo-client', 'graphql-tag'], factory) : factory(global['react-apollo'] = {}, global.React, global.PropTypes, global.redux, global.apolloClient, global.graphqlTag);
})(undefined, function (exports, React, PropTypes, redux, apolloClient, graphqlTag) {
    'use strict';
    ...
    var ApolloProvider = function (_super) {
        ...
        ApolloProvider.prototype.componentWillReceiveProps = function (nextProps) {
            if (nextProps.client !== this.props.client && !nextProps.store && typeof nextProps.client.initStore === 'function') {
    ...
    var invariant$2 = __webpack_require__(15);
    var DocumentType;
    ...
    var invariant$1 = __webpack_require__(15);
    var assign = __webpack_require__(6);
    var hoistNonReactStatics = __webpack_require__(51);
            ...
            var GraphQL = function (_super) {
                ...
                GraphQL.prototype.subscribeToQuery = function () {
                    ...
                    var handleError = function (error) {
                        if (error.hasOwnProperty('graphQLErrors')) return next({ error: error });
                        throw error;
                    };
    ...
    var invariant$3 = __webpack_require__(15);
    var assign$1 = __webpack_require__(6);
    var hoistNonReactStatics$1 = __webpack_require__(51);
...
var _getRawTag = __webpack_require__(64);

var _getRawTag2 = _interopRequireDefault(_getRawTag);

var _objectToString = __webpack_require__(65);
...
var _freeGlobal = __webpack_require__(63);
...
var _overArg = __webpack_require__(67);
...
var _networkInterface = __webpack_require__(18);

var _batchedNetworkInterface = __webpack_require__(77);

var _printer = __webpack_require__(13);

var _store = __webpack_require__(20);

var _ObservableQuery = __webpack_require__(22);
...
var _ApolloClient = __webpack_require__(85);

var _ApolloClient2 = _interopRequireDefault(_ApolloClient);

var _storeUtils = __webpack_require__(2);

var _fragmentMatcher = __webpack_require__(27);
...
var _batching = __webpack_require__(78);
...
var _apolloLinkCore = __webpack_require__(86);

var _fragmentMatcher = __webpack_require__(27);

var _store = __webpack_require__(20);

var _QueryManager = __webpack_require__(95);
...
var _version = __webpack_require__(101);
...
var _source = __webpack_require__(88);

var _error = __webpack_require__(49);

var _lexer = __webpack_require__(92);

var _kinds = __webpack_require__(93);
...
var _Deduplicator = __webpack_require__(96);
...
var _resultReducers = __webpack_require__(98);
...
var _store3 = __webpack_require__(99);

var _scheduler = __webpack_require__(100);
